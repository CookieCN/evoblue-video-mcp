...
`INVALID_URL`、`UNSUPPORTED_PLATFORM`、`METADATA_FETCH_FAILED`、`SUBTITLE_UNAVAILABLE`、`ASR_DISABLED`、`DOWNLOAD_LIMIT_EXCEEDED`、`DISK_SPACE_LOW`、`FFMPEG_MISSING`、`ASR_MODEL_MISSING`、`LLM_NOT_CONFIGURED`、`LLM_AUTH_FAILED`、`LLM_RATE_LIMITED`、`REPORT_CONFLICT`、`INDEX_FAILED`、`ENGINE_RESTARTED`、`CANCELLED_BY_USER`、`INTERNAL_ERROR`。
